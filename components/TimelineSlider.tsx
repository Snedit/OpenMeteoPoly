...
export function TimelineSlider() {
  ...
  const currentHourOffset = differenceInHours(timeRange.currentHour, timeRange.start);
  
  const handleSliderChange = (values: number[]) => {
    const newHour = addHours(timeRange.start, values[0]);
                ...
                <div
                  ...
                  style={{
                    ...
                    background: getTrackBackground({
                      values: [currentHourOffset],
                      colors: ['hsl(213, 88%, 52%)', 'hsl(210, 4%, 89%)'],
                      min: 0,
                      max: totalHours,
                    }),
                    alignSelf: 'center',
